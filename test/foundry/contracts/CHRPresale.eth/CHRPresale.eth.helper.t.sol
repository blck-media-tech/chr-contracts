...
contract CHRPresaleETHHarness is CHRPresaleETH {
    constructor(
        address _saleToken,
        address _oracle,
        address _usdt,
    ...
    ) CHRPresaleETH(_saleToken, _oracle, _usdt, _saleStartTime, _saleEndTime, _limitPerStage, _pricePerStage) {}
...
contract CHRPresaleETHHelper is Test {
    CHRPresaleETHHarness presaleContract;
